...
function Contact() {
    ...
    return (
        <section id="contact" className="flex mt-16 flex-col font-semibold fade-in-up px-4 gap-5 lg:px-0">
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-7">
                <div className=" sm:mt-0s sm:w-3/4 md:w-1/2">
                    <h3 className="mb-6 text-xl text-secondary-dark-theme-color dark:text-white">{language.CONTACT_SEND_ME_MESSAGE}</h3>
                ...
                <div className="sm:ml-auto">
                    <h3 className="mb-6 lg:text-center text-xl text-secondary-dark-theme-color dark:text-white">{language.CONTACT_PERSONAL_INFORMATION}</h3>
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="flex gap-8 flex-wrap lg:justify-center">
                            <HeroButton Icon={IoDocumentTextSharp} text={language.HERO_RESUME} action={"https://drive.google.com/file/d/1U4r5vf6stAyl_5dStgQKkhUlfIfvjRcF/view?usp=sharing"} isHiddenText={false} />
