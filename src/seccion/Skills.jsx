...
function Skills() {
    return (
        <section id="skills" className="flex mt-9 flex-col min-h-screen font-semibold fade-in-up px-4 gap-5 lg:px-0">
            <h2 className="flex items-center gap-x-2 text-4xl"><GiSkills /> Skills</h2>
